...
def get_args():
    ...
    parser.add_argument('--max-tokens', default=200, type=int, help='maximum number of tokens in a batch')
    parser.add_argument('--batch-size', default=50, type=int, help='maximum number of sentences in a batch')
